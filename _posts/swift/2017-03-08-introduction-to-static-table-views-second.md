...
До сих пор мы только, что создали автономный контроллер представления таблицы.
Мы хотим, вызвать контроллер, когда пользователь нажимает на кнопку **"+"**,
...
проекта. В **Attribute inspector** измените идетификатор на **Add** и вы
увидите значок **+**.
...
> **Совет:** Вы можете щелкнуть правой кнопкой мыши любую пустую область в **Storyboard**, вам отобразится zoom, где вы сможете установить свою область увеличения.
...
**UITableViewController**, который создали ранее. В **storyboard** выберете
...
Если вы выберете фотографию из библиотеки, она не будет отображаться в режиме
...
Перед внедрением метода давайте объявим **@IBOutlet** переменную для отображение
изображения. Позже мы установим с выбранным изображением. 

```swift
@IBOutlet weak var photoImageView: UIImageView!
```

Перейдите в **Interface Builder** и соедините изображение ячейки с 
