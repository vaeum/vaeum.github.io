...
**Xcode** позволяет разработчика создавать статические таблицы с минимальным
...
из библиотеки объектов в **StoryBoard**. В **Attribute inspector** измение,
**Content** представление таблицы с **Dynamic Prototypes** на **Static Cells**.
После изменения, вы будете иметь таблицу с тремя пустыми статическими
ячейками.
...
Не написан ни одной строчке кода, вы создаете таблицу с формой с помощью
...
экранов, таких как, **Setting**. В конце у вас должно получится примерно так.
